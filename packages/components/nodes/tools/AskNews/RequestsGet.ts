...
class AskNewsGet_Tools implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'AskNews Get'
        this.name = 'askNewsGet'
        this.version = 1.0
        this.type = 'AskNewsGet'
        this.icon = 'asknews.svg'
        this.category = 'Tools'
        this.description = 'Execute HTTP AskNews GET request'
...
module.exports = { nodeClass: AskNewsGet_Tools }
